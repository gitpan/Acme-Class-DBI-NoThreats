package Acme::Class::DBI::NoThreats::Relationship::HasA;

use strict;
use warnings;

use base 'Acme::Class::DBI::NoThreats::Relationship';
...
sub _inflator {
	...
	return sub {
		...
		$inflator = $a_class->isa('Acme::Class::DBI::NoThreats') ? "_simple_bless" : "new";

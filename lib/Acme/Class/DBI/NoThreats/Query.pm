package Acme::Class::DBI::NoThreats::Query::Base;
...
package Acme::Class::DBI::NoThreats::Query;

use base 'Acme::Class::DBI::NoThreats::Query::Base';
...
Acme::Class::DBI::NoThreats::Query - Deprecated SQL manager for Acme::Class::DBI::NoThreats

=head1 SYNOPSIS

	my $sth = Acme::Class::DBI::NoThreats::Query
		->new({ 
			owner => $class, 
			sqlname => $type, 
			essential => \@columns, 
...
This abstracts away many of the details of the Acme::Class::DBI::NoThreats underlying SQL
...
The Acme::Class::DBI::NoThreats subclass that 'owns' this query. In the vast majority
...
sub new {
	my ($class, $self) = @_;
	require Carp;
	Carp::carp "Acme::Class::DBI::NoThreats::Query deprecated";
	$self->{owner}     ||= caller;
...
sub run {
	my $self = shift;
	my $owner = $self->owner or Acme::Class::DBI::NoThreats->_croak("Query has no owner");

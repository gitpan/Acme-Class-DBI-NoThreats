package Acme::Class::DBI::NoThreats::Relationship;
...
Acme::Class::DBI::NoThreats::Relationship - base class for Relationships

=head1 DESCRIPTION

A Acme::Class::DBI::NoThreats class represents a database table. But merely being able
to represent single tables isn't really that useful - databases are all
about relationships.

So, Acme::Class::DBI::NoThreats provides a variety of Relationship models to represent
common database occurences (HasA, HasMany and MightHave), and provides
a way to add others.

=head1 SUBCLASSING

Relationships should inherit from Acme::Class::DBI::NoThreats::Relationship, and
provide a variety of methods to represent the relationship. For
examples of how these are used see Acme::Class::DBI::NoThreats::Relationship::HasA,
Acme::Class::DBI::NoThreats::Relationship::HasMany and Acme::Class::DBI::NoThreats::Relationship::MightHave.
...
The Acme::Class::DBI::NoThreats subclass to which this relationship applies. This will be
...
This usually an entire application base class (or Acme::Class::DBI::NoThreats itself),
...
Acme::Class::DBI::NoThreats class.  This method can be omitted if there are no methods
to be set up.

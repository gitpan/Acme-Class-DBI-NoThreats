...

{
	...
	isa_ok $it1, "Acme::Class::DBI::NoThreats::Iterator";

	my $it2 = Film->retrieve_all;
	isa_ok $it2, "Acme::Class::DBI::NoThreats::Iterator";
...

{
	my $it = Film->retrieve_all;
	my $slice = $it->slice(2,4);
	isa_ok $slice, "Acme::Class::DBI::NoThreats::Iterator", "slice as iterator";
